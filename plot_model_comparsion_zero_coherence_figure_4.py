'''
The script 'plot_model_comparsion_zero_coherence_figure_4.py' creates the 
visualizations related to the model comparison analysis 
for Figure 4 in "Fard et al. (2021), Spatiotemporal 
...
#################################
#Creating the Figure 4 visualization
#################################
...
ax1.set_ylabel('Protected Exceedance probability')
...
plt.savefig('figures\\Figure_4_model_comparison_DDM_EXaM_0_coherence.jpg', bbox_inches='tight',dpi=300)
plt.savefig('figures\\Figure_4_model_comparison_DDM_EXaM_0_coherence.eps', bbox_inches='tight',dpi=300)
plt.savefig('figures\\Figure_4_model_comparison_DDM_EXaM_0_coherence.tiff', bbox_inches='tight',dpi=300)
