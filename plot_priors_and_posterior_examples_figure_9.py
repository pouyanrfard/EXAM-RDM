...
ax12.xaxis.set_tick_params(pad=3)
ax12.yaxis.set_tick_params(pad=3)
ax12.set_xlabel(r"$\sigma_{sc}$",labelpad=1,fontsize=10)
ax12.fill_between(x,y,color='silver')
ax12.get_xaxis().set_label_coords(0.5,-0.15)
...
ax13.xaxis.set_tick_params(pad=3)
ax13.yaxis.set_tick_params(pad=3)
ax13.set_xlabel(r"$B$",labelpad=1,fontsize=10)
ax13.fill_between(x,y,color='silver')
ax13.get_xaxis().set_label_coords(0.5,-0.15)
...
ax21.xaxis.set_tick_params(pad=3)
ax21.yaxis.set_tick_params(pad=3)
...
ax21.get_xaxis().set_label_coords(0.5,-0.15)
...
#ax22.set_yticks([0,25,50])
ax22.xaxis.set_tick_params(pad=3)
ax22.yaxis.set_tick_params(pad=3)
ax22.set_xlabel(r"$s_Z$",labelpad=1,fontsize=10)
ax22.fill_between(x,y,color='silver')
ax22.get_xaxis().set_label_coords(0.5,-0.15)
...
ax23.xaxis.set_tick_params(pad=3)
ax23.yaxis.set_tick_params(pad=3)
ax23.set_xlabel(r"$\bar T_{nd}$",labelpad=1,fontsize=10)
ax23.fill_between(x,y,color='silver')
ax23.get_xaxis().set_label_coords(0.5,-0.15)
...
ax32.xaxis.set_tick_params(pad=3)
ax32.yaxis.set_tick_params(pad=3)
ax32.set_xlabel(r"$\pi_l$",labelpad=1,fontsize=10)
ax32.fill_between(x,y,color='silver')
ax32.get_xaxis().set_label_coords(0.5,-0.15)
...
ax33.xaxis.set_tick_params(pad=3)
ax33.yaxis.set_tick_params(pad=3)
ax33.set_xlabel('$\pi_{to}$',labelpad=1,fontsize=10)
ax33.fill_between(x,y,color='silver')
ax33.get_xaxis().set_label_coords(0.5,-0.15)
...
ax41.xaxis.set_tick_params(pad=3)
ax41.yaxis.set_tick_params(pad=3)
...
ax41.get_xaxis().set_label_coords(0.5,-0.15)
...
ax42.xaxis.set_tick_params(pad=3)
ax42.yaxis.set_tick_params(pad=3)
ax42.set_xlabel(r"$\sigma_{sc}$",labelpad=1,fontsize=10)
ax42.fill_between(x,y,color='cornflowerblue')
ax42.get_xaxis().set_label_coords(0.5,-0.15)
...
ax43.xaxis.set_tick_params(pad=3)
ax43.yaxis.set_tick_params(pad=3)
ax43.set_xlabel(r"$B$",labelpad=1,fontsize=10)
ax43.fill_between(x,y,color='cornflowerblue')
ax43.get_xaxis().set_label_coords(0.5,-0.15)
...
ax51.xaxis.set_tick_params(pad=3)
ax51.yaxis.set_tick_params(pad=3)
...
ax51.get_xaxis().set_label_coords(0.5,-0.15)
...
ax52.xaxis.set_tick_params(pad=3)
ax52.yaxis.set_tick_params(pad=3)
ax52.set_xlabel(r"$s_Z$",labelpad=1,fontsize=10)
ax52.fill_between(x,y,color='cornflowerblue')
ax52.get_xaxis().set_label_coords(0.5,-0.15)
...
ax53.xaxis.set_tick_params(pad=3)
ax53.yaxis.set_tick_params(pad=3)
...
ax53.get_xaxis().set_label_coords(0.5,-0.15)
...
ax61.xaxis.set_tick_params(pad=3)
ax61.yaxis.set_tick_params(pad=3)
...
ax61.get_xaxis().set_label_coords(0.5,-0.15)
...
ax62.xaxis.set_tick_params(pad=3)
ax62.yaxis.set_tick_params(pad=3)
ax62.set_xlabel(r"$\pi_l$",labelpad=1,fontsize=10)
ax62.fill_between(x,y,color='cornflowerblue')
ax62.get_xaxis().set_label_coords(0.5,-0.15)
...
ax63.xaxis.set_tick_params(pad=3)
ax63.yaxis.set_tick_params(pad=3)
ax63.set_xlabel('$\pi_{to}$',labelpad=1,fontsize=10)
ax63.fill_between(x,y,color='cornflowerblue')
ax63.get_xaxis().set_label_coords(0.5,-0.15)
